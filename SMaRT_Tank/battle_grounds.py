...
class Main_GUI(Tk):
    ...
    def create_gui(self):
        self.main_menu_frame = Main_menu_frame(self, self.screen_width_pixle, self.screen_height_pixle, self.swap_to_main_menu_frame)
...
class Main_menu_frame(ttk.Frame):
    ...
    def __init__(self, master, screen_width, screen_height, button_command):
        ...
        self.other_button = self.create_menu_button("Other", exit, 0, 0)
        self.salinity_button = self.create_menu_button("Salinity", None, 0, 1)
        self.temperature_button = self.create_menu_button("Temperature", None, 1, 0)
        self.ph_button = self.create_menu_button("Ph", None, 1, 1)
